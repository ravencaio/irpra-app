...
então o programa localizará seu terminal no caminho do apelido `projeto-c`. É também possível usar a flag `-e` para simbolizar que o diretório
deve ser aberto também no explorador de arquivos: `irpra -e projetos-c`
...
O usuário deve alterá-la de forma que cada linha contenha o seguinte: `<apelido>;<caminho>;`, exemplo: `projetos-c;D:\programacao\projetos\c;`
